...
function swithcerMenu() {
    if ($('.switch_menu').length) {
        ...
        $('#styleOptions .color1').on('click', function() {
            $('.logo img,.sticky_logo img,.footer_logo a>img').attr('src', 'images/logo/porto_logo.svg');
            ...
            Cookies.set('logo-img', 'images/logo/porto_logo.svg', { expires: 365, path: '/' });
            Cookies.set('logo-img-footer', 'images/logo/porto_logo.svg', { expires: 365, path: '/' });
