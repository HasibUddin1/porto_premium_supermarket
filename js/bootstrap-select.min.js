  ...
  !(function (a) {
      ...
      var h,
        i = this.each(function () {
          ...
          if (b.is("select")) {
            ...
            "string" == typeof e &&
              (h = c[e] instanceof Function ? c[e].apply(c, d) : c.options[e]);
          }
        });
    ...
    a.fn.val = function (a) {
      return (
        this.is("select") &&
          a &&
          this.find('option[value="' + a + '"]').data("selected", !0),
                ...
                if (
                  ...
                  if (d.options.hideDisabled && s) {
                    if (void 0 === p.data("allOptionsDisabled")) {
                      ...
                      p.data(
                        "allOptionsDisabled",
                        t.filter(":disabled").length === t.length,
                      );
                    }
                  ...
                  if (0 === c.index()) {
                    ...
                    var v = p[0].label,
                      w =
                        "undefined" != typeof p.data("subtext")
                          ? '<small class="text-muted">' +
                            p.data("subtext") +
                            "</small>"
                          : "",
