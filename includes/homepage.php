            ...
            <ul>
                ...
                <li
                    ...
                    <div
                        ...
                        style="z-index: 5">
                        <img src="images/home/hero_image1.png" alt="" />
                    </div>
                    ...
                    <div
                        ...
                        data-elementdelay="0.05"
                        style="z-index: 5">
                        <h1>Porto Premium Supermarket</h1>
                    </div>
                    ...
                    <div
                        ...
                        <h5 class="cp-title">
                            Fruits ~ Vegetables ~ Fishes ~ Seafoods ~ Grocery ~ Snacks ~ Canned Foods ~ Frozen Foods
                        </h5>
                    </div>
                    ...
                    <div
                        ...
                        style="z-index: 6; white-space: nowrap">
                        <h5 class="cp-title-2">
                            Premium Groceries, Fresh Choices, Everyday Convenience
                        </h5>
                    </div>
                </li>
                ...
                <li
                    ...
                    <div
                        ...
                        <div class="banner-caption-h1">
                            Premium Quality <br> For Every Basket
                        </div>
                ...
                <li
                    ...
                    <div
                        ...
                        data-elementdelay="0.05"
                        style="z-index: 5">
                        <img src="images/home/hero_image3.png" alt="" />
                    </div>
                    ...
                    <div
                        ...
                        data-splitout="none"
                        data-start="500">
                        <div class="banner-caption-h2">Fresh Premium Choices</div>
                    </div>
                    <div
                        class="tp-caption tp-resizeme text-center"
                        data-x="center"
                        ...
                        data-responsive_offset="on"
                        data-start="1400">
                        <div class="banner-caption-h3">Quality Every Day</div>
                        <div class="banner-caption-p">
                            <p>
                                Fresh groceries and essentials selected for your family's daily needs
                            </p>
                        </div>
                        <a href="#featured_products" class="color1-bg contuct-us">shop now</a>
                    </div>
                </li>
            </ul>
        </div>
...
<!-- TODO: Featured products tab ke database er shathe dynamic korte hobe -->

<?php include_once "featured_products.php"; ?>
    ...
    <div class="container">
        ...
        <div class="float_right">
            <div class="contact-box">
                <form
                    method="post"
                    action="https://st.ourhtmldemo.com/template/organic_store/sendemail.php"
                    class="contact-form"
                    ...
                    <div class="row clearfix">
                        <div class="form-group">
                            <input
                                ...
                                name="username"
                                value=""
                                placeholder="Your Name*" /><i class="fa fa-user" aria-hidden="true"></i>
                        </div>
                        ...
                        <div class="form-group">
                            <input
                                ...
                                name="username"
                                value=""
                                placeholder="Email Address*" /><i class="fa fa-envelope" aria-hidden="true"></i>
                        </div>
